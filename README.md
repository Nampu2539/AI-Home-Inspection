...
1.ระบบแสดงตัวเลือกให้ผู้ใช้คลิกจุดสำหรับ segmentation
2.ผู้ใช้กด “Run Segmentation” → SAM สร้าง masks
3.ผู้ใช้เลือกวัสดุ → ระบบคำนวณราคา
4.ผู้ใช้กดตรวจความเสียหาย → ระบบประมวลผลภาพ
5.ผู้ใช้ไปที่ “Full Report” เพื่อดูข้อมูลสรุปทั้งหมด

🧩 Future Improvements

เพิ่มโมเดล Deep Learning สำหรับ Damage Detection จริง ๆ
Export เป็น PDF Report

แรงค์ความรุนแรงของรอยเสียหาย (Severity Score)

Auto Segmentation โดยไม่ต้องคลิก
